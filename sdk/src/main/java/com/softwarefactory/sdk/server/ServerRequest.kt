...
import com.softwarefactory.sdk.R
import com.softwarefactory.sdk.constant.CommonConstant
import com.softwarefactory.sdk.database.DBAdapter
import com.softwarefactory.sdk.util.LGCUtil
...
class ServerRequest(
    ...
    override fun parseNetworkError(volleyError: VolleyError): VolleyError {
        val errorCode =
            if (volleyError.networkResponse != null) volleyError.networkResponse.statusCode else ServerError.Code.NETWORK_ERROR
